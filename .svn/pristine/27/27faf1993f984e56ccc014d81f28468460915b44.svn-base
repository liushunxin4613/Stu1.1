...
public class SecondHandActivity extends ImmersionActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			fragment = SecondHandFragment.getInstance();
			getSupportFragmentManager().beginTransaction()
					.add(R.id.second_hand_container, fragment).commit();
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		searchView = (DiySearchView) menu.findItem(R.id.action_second_search)
				.getActionView();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			finish();
			return true;
		case R.id.action_second_search:
			return true;
		}
