...
public class GuaGuaKaView extends View {
	...
	public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mCanvas.drawRoundRect(new RectF(0, 0, width, height), 0, 0,
				mOutterPaint);
		mCanvas.drawBitmap(
				BitmapFactory.decodeResource(getResources(), R.drawable.shave),
				null, new RectF(0, 0, width, height), null);
	}
	...
	private void setUpOutPaint() {
		...
		// 设置画笔宽度
		mOutterPaint.setStrokeWidth(35);//
	}
	...
	public void drawPath() {
		...
		if (!ShaveActivity.flag) {
			mCanvas.drawPath(new Path(), mOutterPaint);
		} else {
