...
public class NetworkImageView extends ImageView {
	...
	/**
	 * set up the resource of default image id and error image id and image change Listener
	 * @param defaultImageId
	 * @param errorImageId
	 * @param imageListener
	 */
	public void setUpRes(int defaultImageId, int errorImageId, ImageListener imageListener){
		...
		if (mImageListener == null)
			mImageListener = new ImageListener() {
				...
				public void onResponse(final ImageContainer response,
					...
					// inside of a layout
					// pass do not set the image immediately as it will trigger
					// a requestLayout
